...
const questionElement = document.getElementaryById("question");
const answerButton = document.getElementaryById("answwerbuttons");
const nextButton = document.getElementaryById("next button");
